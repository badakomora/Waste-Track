...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-light bg-white shadow sticky-top" id="navbar">
        ...
        <a href="users.php" class="nav-link text-dark"> <i class="fa fa-users m-2"></i> Users </a>
                ...
                <li class="nav-item">
        <a href="posts.php" class="nav-link text-dark"> <i class="fa fa-sticky-note m-2"></i> Tracks</a>
                </li>
                <li class="nav-item">
        <a href="comments.php" class="nav-link text-dark"> <i class="fa fa-comment m-2"></i> Orders</a>
                </li>
                <li class="nav-item">
