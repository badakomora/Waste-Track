...
<html lang="en">
<head>
<title>Waste Track Management System</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-light bg-white shadow sticky-top" id="navbar">
        <a href="#" class="navbar-brand text-dark p-2 logo" style="font-size: 30px;"><b>Waste Track Management System</b></a>
        ...
        <a href="users.php" class="nav-link text-dark"> <i class="fa fa-users m-2"></i> Users </a>
                ...
                <li class="nav-item">
        <a href="tracks.php" class="nav-link text-dark"> <i class="fa fa-sticky-note m-2"></i> Tracks</a>
                </li>
                <li class="nav-item">
        <a href="orders.php" class="nav-link text-dark"> <i class="fa fa-comment m-2"></i> Orders</a>
                </li>
                <li class="nav-item">
